...
object Libs {
    ...
    val androidx_appcompat_v7 = "androidx.appcompat:appcompat:${Versions.androidx}"
    val androidx_support_v4 = "androidx.legacy:legacy-support-v4:${Versions.androidx}"
    val androidx_annotations = "androidx.annotation:annotation:${Versions.androidx}"
